...
# ------------------------------------------------------------------------------
REPO_PATH="$HOME/github/webappsshowcase"                                    # Caminho local do repositório
...
SITE_URL="https://passosdomingues.github.io/webappsshowcase/site/main.html"

# CORREÇÃO: BASE_URL deve ser exatamente até “/site”, sem repetir “site” depois
BASE_URL="${SITE_URL%/main.html}"   # → "https://passosdomingues.github.io/webappsshowcase/site"

BACKUP_DIR="$HOME/github/webappsshowcase_backup_$(date +%Y%m%d_%H%M%S)"      # Diretório para backup
